...
class RoundRunner:
    def __init__(self, base=None):
        ...
        self.llm = LLMClient(self.s.paths); self.visibility=VisibilityService(self.s); self.evidence=EvidenceService(self.s,self.llm)
...
if __name__=='__main__':
    ...
    try: RoundRunner(ws).run(args.rounds)
