...
import { webfetchDefinition, handleWebfetch } from "./webfetch.js";
import { githubRepoDefinition, handleGithubRepo } from "./github.js";
import {
...
export function registerAllBuiltinTools(
  ...
  const tools = [
    ...
    { def: webfetchDefinition, handler: handleWebfetch },
    { def: githubRepoDefinition, handler: handleGithubRepo },
