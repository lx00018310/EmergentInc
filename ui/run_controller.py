...
from scripts.runner import RoundRunner, OwnerActionRequired
from .loop_store import LoopStore

class RunController:
    def __init__(self, base_dir: str | Path = '.'):
        self.base = Path(base_dir)
        self.storage = Storage(str(self.base))
        self.loop_store = LoopStore(self.base)
        ...
        self.ui_state_dir = self.base / 'ui_state'
    ...
    def _run_loop(self, rounds: int, loop_id: str, start_round: int) -> None:
        ...
        try:
            runner = RoundRunner(str(self.base))
